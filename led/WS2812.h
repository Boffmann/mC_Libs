...
public:
	...
	void setColorChannelsRGBFor(int index, uint8_t red, uint8_t green, uint8_t blue);
	void setColorChannelsRGBAFor(int index, uint8_t red, uint8_t green, uint8_t blue, uint8_t brightness);
