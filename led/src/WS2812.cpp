...
WS2812::WS2812(uint8_t pin_gpio, uint16_t led_count) {
    led_data = new rmt_data_t[bit_resolution*led_count];
	ledCounts = led_count;
	pin = pin_gpio;
	brightness = 255;
}
...
void WS2812::setColorChannelsRGBFor(int index, ColorChannel red, ColorChannel green, ColorChannel blue) {
...
void WS2812::setColorChannelsRGBAFor(int index, ColorChannel red, ColorChannel green, ColorChannel blue, ColorChannel brightness) {
